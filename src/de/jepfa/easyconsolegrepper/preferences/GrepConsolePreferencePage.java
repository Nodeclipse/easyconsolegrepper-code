...
public class GrepConsolePreferencePage  extends FieldEditorPreferencePage
	...
	public GrepConsolePreferencePage() {
	        ...
	        setDescription(Messages.GrepConsolePreferencePage_ConfigureTheBehaviorOfXX + " " + Activator.GREP_CONSOLE_NAME); //$NON-NLS-1$
	}
	...
	public void createFieldEditors() {
	    ...
	    addField(new BooleanFieldEditor(Activator.PREF_DONT_SHOW_DISPOSAL_DIALOG, Messages.GrepConsolePreferencePage_DontAskBeforeDisposedAction, getFieldEditorParent()));

...
public class Activator extends AbstractUIPlugin {
    ...
    public static final String IMAGE_FILTER_ON_OFF_16 = "image.onoff.16"; //$NON-NLS-1$
    ...
    protected void initializeImageRegistry(ImageRegistry registry) {
        ...
        createAndRegisterImage(registry, IMAGE_FILTER_ON_OFF_16, "icons/filteronoff_16.png"); //$NON-NLS-1$
    }
